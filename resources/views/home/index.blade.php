            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="slider__item">
                        <h6 class="title title--overhead"><span class="down-up"><span>Web development</span></span></h6>
                        ...
                        <a class="btn-link btn-link--circle-right" href="projects1.html"><span class="down-up"><span>Подробно<i
                ...
                <div class="swiper-slide">
                    <div class="slider__item">
                        ...
                        <a class="btn-link btn-link--circle-right" href="projects2.html"><span class="down-up"><span>Подробно<i
                                        class="circle circle--right icon-right-open"></i></span></span></a>
                    </div>
                </div>
                <!-- /Caption 2 -->
                ...
                <div class="swiper-slide">
                    <div class="slider__item">
                        ...
                        <a class="btn-link btn-link--circle-right" href="projects3.html"><span class="down-up"><span>Подробно<i
                                        class="circle circle--right icon-right-open"></i></span></span></a>
                    </div>
                </div>
                <!-- /Caption 3 -->
