                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="form-label-group">
                            <input type="text" id="help-title-{{ $lang }}"
                            ...
                            <label for="help-title-{{ $lang }}">{{ __('Title') }} ({{ $lang }})</label>
                    ...
                    <div class="col-md-12 col-12">
                        <fieldset class="form-label-group">
                            <textarea id="help-description-{{ $lang }}"
                            ...
                            <label
                                for="help-description-{{ $lang }}">{{ __('Description') . ' ('. $lang . ')' }}</label>
