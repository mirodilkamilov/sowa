                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        ...
                        <textarea
                            ...
                            rows="4"
                            name="content[text][{{$i}}][title][{{ $lang }}]">{{ old("content.0.title.{$lang}.{$i}") }}</textarea>
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <textarea
                            ...
                            rows="4"
                            name="content[text][{{$i}}][description][{{ $lang }}]">{{ old("content.0.description.{$lang}.{$i}") }}</textarea>
                            <label
