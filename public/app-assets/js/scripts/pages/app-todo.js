...
$(function () {
    ...
    var $curr_title, $curr_phone, $curr_desc, $curr_comm, $curr_info, $curr_fav, $curr_chipVal;
    ...
    $(document).on('click', ".todo-task-list-wrapper .todo-item", function (e) {
        ...
        $curr_phone = $(this).find('.user-phone');
        ...
        var $phone = $(this).find('.user-phone').html();
        ...
        $('#form-edit-todo .edit-todo-item-phone').val($phone);
