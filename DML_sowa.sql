...
VALUES  (1, '{"en": null, "ru": "Мобильные приложения", "uz": null}', '{"en": null, "ru": "MOBILE APPS", "uz": null}', '{"en": null, "ru": "Мобильное приложение - это возможность увеличения продаж и лояльности ваших клиентов. Теперь ваш бизнес всегда находится в кармане у клиентов. Вы можете всегда быть на связи и применять все способы стимулирования покупок. А мы поможем сделать это приложение удобным и понятным, чтобы оно стало мощным маркетинговым инструментом.", "uz": null}', 1, 'slides/9xZQyd7iHhXLOofGz1VdB8lYCQSDvQQ3ZzHulOxU.jpg', 1, NULL),
        (2, '{"en": null, "ru": "Веб-дизайн", "uz": null}', '{"en": null, "ru": "Web development", "uz": null}', '{"en": null, "ru": "Наличие сайта у компании, показывает её технологичность и поддерживает её иммидж. Современный дизайн и детальное описание деятельности компании - это ключ к высоким продажам и созданию положительного мнения клиентов.", "uz": null}', 2, 'slides/1NAyTqqHUCOneq0w7weQmRmVO1vT3vfFCyyE1pA9.jpg', 2, NULL),
        (3, '{"en": null, "ru": "Графический дизайн", "uz": null}', '{"en": null, "ru": "Design", "uz": null}', '{"en": null, "ru": "Дизайн способен подчеркнуть иммидж и статус компании. Потому что правильное визуальное оформление увеличивает конверсию и интерес к бренду.", "uz": null}', 3, 'slides/UgPSbdZI3KA19jjZUpm9vIi20lpJ3NVqbqQo1jRr.jpg', 3, NULL),
